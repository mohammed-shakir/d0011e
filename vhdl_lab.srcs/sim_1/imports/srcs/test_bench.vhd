...
begin
  ...
  part3b_instance: part3b port map(a => a, c => c, d => d, f => f2);
  part4_instance: part4 port map(x => x, y => y2);
  ...
  begin
    ...
    assert f2 = '1' report "Assertion violation in Input value 0 failed";
    ...
    assert f2 = '0' report "Assertion violation in Input value 1 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 2 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 3 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 4 failed";
    ...
    assert f2 = '0' report "Assertion violation in Input value 5 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 6 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 7 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 8 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 9 failed";
    ...
    assert f2 = '0' report "Assertion violation in Input value 10 failed";
    ...
    assert f2 = '0' report "Assertion violation in Input value 11 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 12 failed";
    ...
    assert f2 = '1' report "Assertion violation in Input value 13 failed";
    ...
    assert f2 = '0' report "Assertion violation in Input value 14 failed";
    ...
    assert f2 = '0' report "Assertion violation in Input value 15 failed";
